      ...
      <div className="info">
        <div className="info1">
          ...
          <label className="dtNascimento">
            Data Nasc.: <p>{format(new Date(props.dtNasc), "dd/MM/yyyy") || "31/12/2000"}</p>
          </label>
        ...
        <div className="info2">
          ...
          </label>
          {
            ...
            //ainda em caso de ser paciente outro operador ternario, se for ativo(true)
            //muda o style da tag p para ficar o texto verde, se for inativo(false) muda pra vermelho
