...
function ListagemNutri() {
  ...
  useEffect(() => {
    api
      .get("http://localhost:8080/api/nutricionista/getAll")
      .then((response) => {
      ...
      <div className="corpo">
        <div className="header">
          ...
          <div className="botaocadastro">
            <Link to="/cadastroNutri">
              <Button
                id="bt"
                label="Cadastrar Nutricionista"
                icon="pi pi-id-card"
                iconPos="left"
                data-toggle="tooltip"
        ...
        <div className="fundobranco">
          {
            ...
            nutris.length === 0 ? (
              <h3>
                Nenhum profissional de nutrição cadastrado.😅 Cadastre agora
